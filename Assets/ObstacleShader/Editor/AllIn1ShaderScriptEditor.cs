    ...
    public class AllIn1ShaderScriptEditor : UnityEditor.Editor
    {
                    ...
                    if (isUrp || myScript.shaderTypes != AllIn1Shader.ShaderTypes.Urp2dRenderer)
                    {
                        ...
                        if (sr != null)
                        {
                            if (sr.sharedMaterial != null)
                            {
                                ...
                                if (myScript.shaderTypes == AllIn1Shader.ShaderTypes.Default) sr.sharedMaterial.shader = Resources.Load("ObstacleShader", typeof(Shader)) as Shader;
                        ...
                        else
                        {
                            ...
                            if (img != null && img.material != null)
                            {
                                ...
                                if (myScript.shaderTypes == AllIn1Shader.ShaderTypes.Default) img.material.shader = Resources.Load("ObstacleShader", typeof(Shader)) as Shader;
        ...
        private void ChooseAndDiplayAssetImage()
        {
            ...
            switch(imageType)
            {
                ...
                {
                    imageInspector =
                        (Texture2D) AssetDatabase.LoadAssetAtPath("Assets/ObstacleShader/Textures/CustomEditorImage.png",
                            typeof(Texture2D));
                    break;
                }
        ...
        private void SetCurrentShaderType(AllIn1Shader myScript)
        {
            ...
            shaderName = shaderName.Replace("ObstacleShader/", "");

            if (shaderName.Equals("ObstacleShader")) myScript.shaderTypes = AllIn1Shader.ShaderTypes.Default;
