...
namespace ObstacleShader
{
    ...
    [AddComponentMenu("ObstacleShader/AddAllIn1Shader")]
    public class AllIn1Shader : MonoBehaviour
    {
        ...
        private void MakeNewMaterial(bool getShaderTypeFromPrefs, string shaderName = "ObstacleShader")
        {
        ...
        {
            if (shaderTypes == ShaderTypes.Default) return "ObstacleShader";
        ...
        private void SetMaterial(AfterSetAction action, bool getShaderTypeFromPrefs, string shaderName)
        {
            ...
            {
                Debug.LogError("Make sure the ObstacleShader shader variants are inside the Resource folder!");
            }
        }
