...
namespace ObstacleShader
{
    public class AllIn1ShaderWindow : EditorWindow
    {
        ...
        public static readonly string materialsSavesPath = "Assets/ObstacleShader/Materials";
        public static readonly string renderImagesSavesPath = "Assets/ObstacleShader/Textures";
        public static readonly string normalMapSavesPath = "Assets/ObstacleShader/Textures/NormalMaps";
        public static readonly string gradientSavesPath = "Assets/ObstacleShader/Textures/GradientTextures";
